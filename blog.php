...
include_once 'dbconnect.php';
    ...
    $count=1;
    $res=mysql_query("SELECT * FROM article WHERE art_id='$count'");
...
<body>
    ...
    <section id="blog" class="container">
        <div class="center">
            <h2>Blogs</h2>
            <p class="lead">All The Article Are Here</p>
        </div>
        <div class="blog">
            <div class="row">
                 <div class="col-md-8">
                    <div class="blog-item" style="display:<?php if($count>$num_rows){echo "none";}else{$count++;}?>">
                        <div class="row">
                            <div class="col-xs-12 col-sm-2 text-center">
                                <div class="entry-meta">
                                    <span id="publish_date"><?php echo $row['time']?></span>
                                    <span><i class="fa fa-user"></i><a href="#"><?php echo $row['author']?></a></span>
                                </div>
                            </div>
                                
                            <div class="col-xs-12 col-sm-10 blog-content">
                                <a href="#"><img class="img-responsive img-blog" src="article/<?php echo $row['file']?>" width="80%" height="20%" alt=""></a>
                                <h2><a href="blog-item.html"><?php echo $row['title']?></a></h2>
